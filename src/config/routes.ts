...
export function registerRoutes() {
	const routes = [creatUserRoute, authUserRoute, updateUserRoute, deleteUserRoute, getUserRoute, createProductRoute, deleteProductRoute, updateProductRoute, getProductsRoute, getProductsByIdRoute, registerSaleRoute, createSupplierRoute, updateSupplierRoute, deleteSupplierRoute, getSupplierRoute, createproductSupplierRoute, getProductsSupplierRoute];
